...
class MyLeNet_trainer():
    ...
    def batch_train_data(self, batch_size=256, shuffle=True):
        ...
        self.X_train = train_data.x_aug
        self.y_train = train_data.y_aug
        #############################################################
        # END TODO
        #############################################################
    ...
    def train_epoch(self, epoch):
        ...
        for batch in range(self.n_batches): 
            train_x_batch, train_y_batch = next(self.train_data_next_batch)
            self.train_step(train_x_batch, train_y_batch)
        #############################################################
        # END TODO
        #############################################################
